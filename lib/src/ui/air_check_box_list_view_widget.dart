...
class AirCheckBoxListViewWidget extends StatefulWidget {
  ...
  Widget _titleWidget;
  AirCheckBoxListViewWidget.defaultStyle({
    @required List list,
  ...
  @override
  _AirCheckBoxListViewWidgetState createState() =>
      _AirCheckBoxListViewWidgetState();
}

class _AirCheckBoxListViewWidgetState extends State<AirCheckBoxListViewWidget> {
  _getContentWidget() {
